...
async function mockDriver(page, context, {
  ...
  await page.exposeFunction("__p3DriverMockFetch", async ({
    ...
    if (url.pathname === "/api/driver/client-version") {
      return json({ currentVersion: "2026.08.05.3", minimumVersion: "2026.08.05.3", isCurrent: true, offlineEnabled, offlineModeRevision: 1 }, 200, {
        "X-MBBS-Driver-Current-Version": "2026.08.05.3",
        "X-MBBS-Driver-Minimum-Version": "2026.08.05.3"
      });
    }
