...
const P3_DEDICATED_MUTATION_RUNNERS = Object.freeze([
  ...
  "run-dispatch-co-group-identity-mutations.mjs",
  ...
  "run-dispatch-planning-stale-identity-location-mutations.mjs",
  ...
  "run-dispatch-unplan-freshness-mutations.mjs",
  ...
  "run-scm-po-split-live-schedule-mutations.mjs",
  "run-scm-po-split-ref-reuse-mutations.mjs",
  "run-scm-po-split-status-consistency-mutations.mjs",
  "run-scm-po-split-ui-mutations.mjs",
  "run-scm-reconcile-review-automation-mutations.mjs",
  ...
  "run-smart-scm-blanket-residual-coverage-mutations.mjs",
  "run-smart-scm-manual-controls-mutations.mjs",
  "run-smart-scm-phased-po-split-mutations.mjs",
