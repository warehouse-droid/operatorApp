...
export async function processNetSuiteOrderWebhook(payload = {}, { scheduleDelayedStatus = true } = {}) {
  ...
  return { ok: true, orderId: payload.id, tranid: payload.tranid, recordType: type, results, stockRequestTransfer };
}
