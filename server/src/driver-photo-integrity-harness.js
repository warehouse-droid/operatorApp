...
const recoveryAssetVersion = "20260812-driver-pwa-v3";
...
assert.match(
  driverWorker,
  /importScripts\("\/driver-photo-hash\.js\?v=20260812-driver-pwa-v3"\);[\s\S]*importScripts\("\/driver-offline-sync\.js\?v=20260812-driver-pwa-v3"\);/,
