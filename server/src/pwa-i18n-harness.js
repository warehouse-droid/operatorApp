...
const representativeDriverWarnings = [
  ...
  "There are already 192 unsynchronized photos. Synchronize before taking more required photos.",
  ...
  "There is not enough protected photo headroom for the remaining route. Synchronize before taking this required photo.",
  "There is not enough protected device storage headroom for the remaining required route photos. Synchronize or reconnect before taking this photo.",
