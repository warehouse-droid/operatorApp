...
assert.ok(serviceWorker.includes("mbbs-yard-operator-v138-toronto-timestamps-v1"), "Operator service-worker cache must advance.");
...
includesAll(serviceWorker, [
  "mbbs-yard-operator-v138-toronto-timestamps-v1",
