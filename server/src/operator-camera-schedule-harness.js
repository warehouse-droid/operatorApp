...
assert.ok(serviceWorker.includes("mbbs-yard-operator-v134-driver-cache-isolation-v1"), "Operator service-worker cache must advance.");
...
includesAll(serviceWorker, [
  "mbbs-yard-operator-v134-driver-cache-isolation-v1",
