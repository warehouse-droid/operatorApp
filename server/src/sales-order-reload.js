...
export function buildSalesOrderReattemptTargets({ preview = {}, selections = [] } = {}) {
  ...
  const targets = previewLines.map((line) => {
    ...
    return {
      ...
      itemId: line.currentItemId,
      itemName: line.currentItemName || line.currentSku,
      sku: line.currentSku,
      itemDescription: line.currentDescription,
      salesUom: line.currentSalesUom || line.historicalSalesUom,
