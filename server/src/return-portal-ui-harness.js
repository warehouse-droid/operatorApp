...
assert.match(controlHtml, /control\.js\?v=20260729-return-management-v2/);
assert.match(adminHtml, /control\.js\?v=20260729-return-automation-v2/);
...
assert.match(smartHtml, /scm-smart\.css\?v=20260729-return-policy-v1/);
assert.match(smartHtml, /scm-smart\.js\?v=20260729-return-policy-v1/);
