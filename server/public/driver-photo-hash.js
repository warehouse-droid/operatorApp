(function driverPhotoHash(global) {
  "use strict";
  ...
  async function toArrayBuffer(value) {
    ...
    throw new TypeError("SHA-256 input must be a Blob, ArrayBuffer, or typed array.");
  }
  ...
  async function sha256(value) {
    ...
    try {
      ...
      // WebKit can expose SubtleCrypto while rejecting digest in a PWA context.
    }
    return sha256Fallback(bytes);
  }

  global.DriverPhotoHash = { sha256 };
